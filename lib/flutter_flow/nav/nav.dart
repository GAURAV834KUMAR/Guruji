...
class AppStateNotifier extends ChangeNotifier {
  GurujiFirebaseUser? initialUser;
  GurujiFirebaseUser? user;
  ...
  void update(GurujiFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'profileMe',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'Profile_Me')
                  : ProfileMeWidget(),
            ),
            FFRoute(
              name: 'Orders',
            ...
            FFRoute(
              name: 'Refferal_Code',
              path: 'refferalCode',
              builder: (context, params) => RefferalCodeWidget(),
            ),
            FFRoute(
              name: 'Settings',
              path: 'settings',
